...
function Home() {
  ...
  const run = async (args: GenerateArgs) => {
    ...
    try {
      ...
      } else if (msg === "youtube_audio_unavailable") {
        toast.error("تعذّر الوصول إلى صوت هذا الفيديو. تأكدي أن الفيديو عام وغير مقيّد بالعمر أو المنطقة.");
      } else if (msg === "youtube_audio_too_large") {
